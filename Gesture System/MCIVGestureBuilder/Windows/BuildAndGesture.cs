...
{
    public partial class BuildAndGesture : Form
    {        
        public AndAction Action { get; private set; }
 
        public BuildAndGesture()
        {
            InitializeComponent();
            CBActionType.SelectedIndex = 0;
        }

        private void BuildAndGesture_Load( object sender, EventArgs e )
        {
        ...
        private void BOK_Click( object sender, EventArgs e )
        {
            ...
            {
                MessageBox.Show( "Please asign the action a anme" );
                return;
            }
        ...
        public void BuildFromAction( AndAction pastAction )
        {
            Action = pastAction;
